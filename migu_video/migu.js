...
function get_enpassword(pwd, a) {
    ...
    // };
    c = new RSAKey;
    // console.log(a.result.modulus);
    // console.log((a.result.modulus, a.result.publicExponent));
...
function rsaFingerprint(a, b) {
    ...
    //result: FingerPrint  details: FingerPrintDetail
    return {
        details: f,
        result: h
    }
...
///////////////////////////
function get_RsaAccout(account, a) {
    // a = {
    //     "status": 2000,
    //     "message": "",
    //     "header": {},
...
console.log(get_enpassword('111111'));
b = get_fingerPrint();
